...
public class AddDB {
    ...
    public void addProduct(String food, String dose, String cost, String image) throws SQLException, ClassNotFoundException {
        System.out.println("dao");
            dbCon.connect().executeUpdate("INSERT INTO menu ( food, dose,cost,  image) VALUES('" + food+ "'," + Integer.parseInt(dose) + "," + Integer.parseInt(cost) + ",'images/" + image + "') ");
    }
