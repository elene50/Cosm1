        ...
        <div id="content">
         <div id="welcome">
            <div id="sidebar">
                ...
                <br><br><br><br><br>   
                <p align="center"><font color = "#862909" face="sans-serif" size = "+3"><i><b>Оплата заказа Вами будет произведена наличными курьеру при получении заказа.<br><br><br>Спасибо, что воспользовались нашими услугами!</b></i></font></p>
