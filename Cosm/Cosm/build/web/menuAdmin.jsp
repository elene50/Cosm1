            ...
            <div id="welcome">
                ...
                <table class="" width="750">
                    ...
                    <form  action="add.jsp">
                                ...
                                <p align="center"><font color = "#862909" face="sans-serif" size = "+2"><i>  <li><a href="grafic.jsp">Просмотреть гистограмму стоимости товаров</a></li></i></font></p>
                    <c:forEach items="${requestScope.menu}" var="value">    
                        <tr>
