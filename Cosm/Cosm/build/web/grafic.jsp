        ...
        <div id="content">
          <div id="welcome">
            <div id="sidebar">
                ...
                <br><br><br><br><br>   
                <p align="center"><font color = "#862909" face="sans-serif" size = "+3"><i><b>Гистограмма распредения цен на товары<br></b></i></font></p<br><br><br>
                                <table width="700">
                    <tr>
                        <td width = "300" align = center><img src = "images/grafic.png" ></td>        
                                            <tr>
                    </table>
            </div>
        </div>
